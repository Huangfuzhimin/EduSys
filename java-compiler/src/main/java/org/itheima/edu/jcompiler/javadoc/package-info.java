...
The invocation is defined by the abstract {@link org.itheima.edu.jcompiler.javadoc.Doclet} class
-- the entry point is the {@link org.itheima.edu.jcompiler.javadoc.Doclet#start(RootDoc) start} method:
<pre>
    public static boolean <b>start</b>(RootDoc root)
</pre>
The {@link org.itheima.edu.jcompiler.javadoc.RootDoc} instance holds the root of the program structure
...
{@link org.itheima.edu.jcompiler.javadoc.PackageDoc#allClasses(boolean) allClasses(false)}.)
<p>

<a name="class"></a>
Throughout this API, the term <em>class</em> is normally a
shorthand for "class or interface", as in: {@link org.itheima.edu.jcompiler.javadoc.ClassDoc},
{@link org.itheima.edu.jcompiler.javadoc.PackageDoc#allClasses() allClasses()}, and
{@link org.itheima.edu.jcompiler.javadoc.PackageDoc#findClass(String) findClass(String)}.
In only a couple of other places, it means "class, as opposed to interface",
as in:  {@link org.itheima.edu.jcompiler.javadoc.Doc#isClass()}.
In the second sense, this API calls out four kinds of classes:
{@linkplain org.itheima.edu.jcompiler.javadoc.Doc#isOrdinaryClass() ordinary classes},
{@linkplain org.itheima.edu.jcompiler.javadoc.Doc#isEnum() enums},
{@linkplain org.itheima.edu.jcompiler.javadoc.Doc#isError() errors} and
{@linkplain org.itheima.edu.jcompiler.javadoc.Doc#isException() exceptions}.
...
{@link org.itheima.edu.jcompiler.javadoc.Doclet Doclet} is an abstract class that specifies
the invocation interface for doclets,
{@link org.itheima.edu.jcompiler.javadoc.Doclet Doclet} holds class or interface information,
{@link org.itheima.edu.jcompiler.javadoc.ExecutableMemberDoc} is a
superinterface of {@link org.itheima.edu.jcompiler.javadoc.MethodDoc} and
{@link org.itheima.edu.jcompiler.javadoc.ConstructorDoc},
and {@link org.itheima.edu.jcompiler.javadoc.ParamTag} holds information
...
@see org.itheima.edu.jcompiler.javadoc.Doclet
@see org.itheima.edu.jcompiler.javadoc.RootDoc
*/
@jdk.Exported
package org.itheima.edu.jcompiler.javadoc;
