...
public abstract class JavacTask implements CompilationTask {
    ...
    public static JavacTask instance(ProcessingEnvironment processingEnvironment) {
        if (!processingEnvironment.getClass().getName().equals(
                "org.itheima.edu.jcompiler.tools.javac.processing.JavacProcessingEnvironment"))
     ...
     * {@link org.itheima.edu.jcompiler.source.util.Trees Trees}.
     * @see org.itheima.edu.jcompiler.source.util.Trees#getTypeMirror
     */
