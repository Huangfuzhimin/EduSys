...
package org.itheima.edu.jcompiler.source.util;
...
public abstract class Trees {
    ...
    public static Trees instance(CompilationTask task) {
        ...
        if (!taskClassName.equals("org.itheima.edu.jcompiler.tools.javac.api.JavacTaskImpl")
                && !taskClassName.equals("org.itheima.edu.jcompiler.tools.javac.api.BasicJavacTask"))
    ...
    public static Trees instance(ProcessingEnvironment env) {
        if (!env.getClass().getName().equals("org.itheima.edu.jcompiler.tools.javac.processing.JavacProcessingEnvironment"))
            throw new IllegalArgumentException();
    ...
    static Trees getJavacTrees(Class<?> argType, Object arg) {
        try {
            ...
            Class<?> c = Class.forName("org.itheima.edu.jcompiler.tools.javac.api.JavacTrees", false, cl);
