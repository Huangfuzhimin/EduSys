...
public class SourceToHTMLConverter {
    ...
    public void convertClass(ClassDoc cd, DocPath outputdir) {
        ...
        try {
            ...
            if (sp instanceof org.itheima.edu.jcompiler.tools.javadoc.SourcePositionImpl) {
                FileObject fo = ((org.itheima.edu.jcompiler.tools.javadoc.SourcePositionImpl) sp).fileObject();
                if (fo == null)
                    return;
