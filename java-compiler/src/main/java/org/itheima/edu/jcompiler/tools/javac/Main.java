...
package org.itheima.edu.jcompiler.tools.javac;
...
public class Main {
    ...
    public static int compile(String[] args) {
        org.itheima.edu.jcompiler.tools.javac.main.Main compiler =
            new org.itheima.edu.jcompiler.tools.javac.main.Main("javac");
    ...
    public static int compile(String[] args, PrintWriter out) {
        org.itheima.edu.jcompiler.tools.javac.main.Main compiler =
            new org.itheima.edu.jcompiler.tools.javac.main.Main("javac", out);
        return compiler.compile(args).exitCode;
    }
}
