...
package org.itheima.edu.jcompiler.tools.javac.api;
...
import org.itheima.edu.jcompiler.source.doctree.DocCommentTree;
import org.itheima.edu.jcompiler.source.doctree.DocTree;
import org.itheima.edu.jcompiler.source.tree.CatchTree;
import org.itheima.edu.jcompiler.source.tree.CompilationUnitTree;
import org.itheima.edu.jcompiler.source.tree.Scope;
import org.itheima.edu.jcompiler.source.tree.Tree;
import org.itheima.edu.jcompiler.source.util.DocSourcePositions;
import org.itheima.edu.jcompiler.source.util.DocTreePath;
import org.itheima.edu.jcompiler.source.util.DocTreeScanner;
import org.itheima.edu.jcompiler.source.util.DocTrees;
import org.itheima.edu.jcompiler.source.util.JavacTask;
import org.itheima.edu.jcompiler.source.util.TreePath;
import org.itheima.edu.jcompiler.tools.javac.code.Flags;
import org.itheima.edu.jcompiler.tools.javac.code.Kinds;
import org.itheima.edu.jcompiler.tools.javac.code.Symbol;
import org.itheima.edu.jcompiler.tools.javac.code.Symbol.ClassSymbol;
import org.itheima.edu.jcompiler.tools.javac.code.Symbol.MethodSymbol;
import org.itheima.edu.jcompiler.tools.javac.code.Symbol.PackageSymbol;
import org.itheima.edu.jcompiler.tools.javac.code.Symbol.TypeSymbol;
import org.itheima.edu.jcompiler.tools.javac.code.Symbol.VarSymbol;
import org.itheima.edu.jcompiler.tools.javac.code.Type;
import org.itheima.edu.jcompiler.tools.javac.code.Type.ArrayType;
import org.itheima.edu.jcompiler.tools.javac.code.Type.ClassType;
import org.itheima.edu.jcompiler.tools.javac.code.Type.ErrorType;
import org.itheima.edu.jcompiler.tools.javac.code.Type.UnionClassType;
import org.itheima.edu.jcompiler.tools.javac.code.Types;
import org.itheima.edu.jcompiler.tools.javac.code.Types.TypeRelation;
import org.itheima.edu.jcompiler.tools.javac.comp.Attr;
import org.itheima.edu.jcompiler.tools.javac.comp.AttrContext;
import org.itheima.edu.jcompiler.tools.javac.comp.Enter;
import org.itheima.edu.jcompiler.tools.javac.comp.Env;
import org.itheima.edu.jcompiler.tools.javac.comp.MemberEnter;
import org.itheima.edu.jcompiler.tools.javac.comp.Resolve;
import org.itheima.edu.jcompiler.tools.javac.model.JavacElements;
import org.itheima.edu.jcompiler.tools.javac.processing.JavacProcessingEnvironment;
import org.itheima.edu.jcompiler.tools.javac.tree.DCTree;
import org.itheima.edu.jcompiler.tools.javac.tree.DCTree.DCBlockTag;
import org.itheima.edu.jcompiler.tools.javac.tree.DCTree.DCDocComment;
import org.itheima.edu.jcompiler.tools.javac.tree.DCTree.DCEndPosTree;
import org.itheima.edu.jcompiler.tools.javac.tree.DCTree.DCErroneous;
import org.itheima.edu.jcompiler.tools.javac.tree.DCTree.DCIdentifier;
import org.itheima.edu.jcompiler.tools.javac.tree.DCTree.DCParam;
import org.itheima.edu.jcompiler.tools.javac.tree.DCTree.DCReference;
import org.itheima.edu.jcompiler.tools.javac.tree.DCTree.DCText;
import org.itheima.edu.jcompiler.tools.javac.tree.EndPosTable;
import org.itheima.edu.jcompiler.tools.javac.tree.JCTree;
import org.itheima.edu.jcompiler.tools.javac.tree.JCTree.*;
import org.itheima.edu.jcompiler.tools.javac.tree.TreeCopier;
import org.itheima.edu.jcompiler.tools.javac.tree.TreeInfo;
import org.itheima.edu.jcompiler.tools.javac.tree.TreeMaker;
import org.itheima.edu.jcompiler.tools.javac.util.Abort;
import org.itheima.edu.jcompiler.tools.javac.util.Assert;
import org.itheima.edu.jcompiler.tools.javac.util.Context;
import org.itheima.edu.jcompiler.tools.javac.util.JCDiagnostic;
import org.itheima.edu.jcompiler.tools.javac.util.List;
import org.itheima.edu.jcompiler.tools.javac.util.ListBuffer;
import org.itheima.edu.jcompiler.tools.javac.util.Log;
import org.itheima.edu.jcompiler.tools.javac.util.Name;
import org.itheima.edu.jcompiler.tools.javac.util.Names;
import org.itheima.edu.jcompiler.tools.javac.util.Pair;
import org.itheima.edu.jcompiler.tools.javac.util.Position;
import static org.itheima.edu.jcompiler.tools.javac.code.TypeTag.*;
...
public class JavacTrees extends DocTrees {
    ...
    /** @see org.itheima.edu.jcompiler.tools.javadoc.ClassDocImpl#findField */
    private VarSymbol findField(ClassSymbol tsym, Name fieldName) {
        return searchField(tsym, fieldName, new HashSet<ClassSymbol>());
    }

    /** @see org.itheima.edu.jcompiler.tools.javadoc.ClassDocImpl#searchField */
    private VarSymbol searchField(ClassSymbol tsym, Name fieldName, Set<ClassSymbol> searched) {
        ...
        for (org.itheima.edu.jcompiler.tools.javac.code.Scope.Entry e = tsym.members().lookup(fieldName);
    ...
    /** @see org.itheima.edu.jcompiler.tools.javadoc.ClassDocImpl#findConstructor */
    MethodSymbol findConstructor(ClassSymbol tsym, List<Type> paramTypes) {
        for (org.itheima.edu.jcompiler.tools.javac.code.Scope.Entry e = tsym.members().lookup(names.init);
                e.scope != null; e = e.next()) {
    ...
    /** @see org.itheima.edu.jcompiler.tools.javadoc.ClassDocImpl#findMethod */
    ...
    /** @see org.itheima.edu.jcompiler.tools.javadoc.ClassDocImpl#searchMethod */
    private MethodSymbol searchMethod(ClassSymbol tsym, Name methodName,
        ...
        org.itheima.edu.jcompiler.tools.javac.code.Scope.Entry e = tsym.members().lookup(methodName);
    ...
    /** @see org.itheima.edu.jcompiler.tools.javadoc.ClassDocImpl */
    ...
    public boolean isAccessible(Scope scope, Element member, DeclaredType type) {
        if (scope instanceof JavacScope
                ...
                && type instanceof org.itheima.edu.jcompiler.tools.javac.code.Type) {
            Env<AttrContext> env = ((JavacScope) scope).env;
            return resolve.isAccessible(env, (org.itheima.edu.jcompiler.tools.javac.code.Type)type, (Symbol)member, true);
        } else
            return false;
    }
...
//                    System.err.println("DEFAULT: " + tree.getKind());
    ...
    public TypeMirror getOriginalType(javax.lang.model.type.ErrorType errorType) {
        if (errorType instanceof org.itheima.edu.jcompiler.tools.javac.code.Type.ErrorType) {
            return ((org.itheima.edu.jcompiler.tools.javac.code.Type.ErrorType)errorType).getOriginalType();
        }

        return org.itheima.edu.jcompiler.tools.javac.code.Type.noType;
    }
    ...
    public void printMessage(Diagnostic.Kind kind, CharSequence msg,
            org.itheima.edu.jcompiler.source.tree.Tree t,
            org.itheima.edu.jcompiler.source.tree.CompilationUnitTree root) {
        printMessage(kind, msg, ((JCTree) t).pos(), root);
    }

    public void printMessage(Diagnostic.Kind kind, CharSequence msg,
            org.itheima.edu.jcompiler.source.doctree.DocTree t,
            org.itheima.edu.jcompiler.source.doctree.DocCommentTree c,
            org.itheima.edu.jcompiler.source.tree.CompilationUnitTree root) {
