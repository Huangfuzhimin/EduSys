...
*/
// Code duplicated in org.itheima.edu.jcompiler.tools.classfile.TypeAnnotation.Position
public class TypeAnnotationPosition {
    ...
    // In org.itheima.edu.jcompiler.tools.javac.jvm.Gen.genCatch we first set the type_index
    // to the catch type index - that value is only temporary.
    // Then in org.itheima.edu.jcompiler.tools.javac.jvm.Code.fillExceptionParameterPositions
