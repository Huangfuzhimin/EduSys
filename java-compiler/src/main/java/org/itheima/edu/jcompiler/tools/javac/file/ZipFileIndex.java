...
package org.itheima.edu.jcompiler.tools.javac.file;
...
import org.itheima.edu.jcompiler.tools.javac.file.RelativePath.RelativeDirectory;
import org.itheima.edu.jcompiler.tools.javac.file.RelativePath.RelativeFile;
...
public class ZipFileIndex {
     ...
     */
    public synchronized org.itheima.edu.jcompiler.tools.javac.util.List<String> getFiles(RelativeDirectory path) {
        try {
            checkIndex();

            DirectoryEntry de = directories.get(path);
            org.itheima.edu.jcompiler.tools.javac.util.List<String> ret = de == null ? null : de.getFiles();

            if (ret == null) {
                return org.itheima.edu.jcompiler.tools.javac.util.List.<String>nil();
            }
            return ret;
        }
        catch (IOException e) {
    ...
    public synchronized List<String> getDirectories(RelativeDirectory path) {
        try {
            ...
            DirectoryEntry de = directories.get(path);
            org.itheima.edu.jcompiler.tools.javac.util.List<String> ret = de == null ? null : de.getDirectories();
   ...
   */
    ...
    static class DirectoryEntry {
        ...
        private org.itheima.edu.jcompiler.tools.javac.util.List<String> zipFileEntriesFiles = org.itheima.edu.jcompiler.tools.javac.util.List.<String>nil();
        private org.itheima.edu.jcompiler.tools.javac.util.List<String> zipFileEntriesDirectories = org.itheima.edu.jcompiler.tools.javac.util.List.<String>nil();
        private org.itheima.edu.jcompiler.tools.javac.util.List<Entry>  zipFileEntries = org.itheima.edu.jcompiler.tools.javac.util.List.<Entry>nil();
        ...
        private org.itheima.edu.jcompiler.tools.javac.util.List<String> getFiles() {
            if (!filesInited) {
                initEntries();
                for (Entry e : entries) {
                    if (!e.isDir) {
        ...
        private org.itheima.edu.jcompiler.tools.javac.util.List<String> getDirectories() {
        ...
        private org.itheima.edu.jcompiler.tools.javac.util.List<Entry> getEntries() {
            if (!zipFileEntriesInited) {
                initEntries();
                zipFileEntries = org.itheima.edu.jcompiler.tools.javac.util.List.nil();
