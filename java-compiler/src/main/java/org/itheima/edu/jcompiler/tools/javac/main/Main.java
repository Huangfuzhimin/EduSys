...
import org.itheima.edu.jcompiler.source.util.Plugin;
import org.itheima.edu.jcompiler.tools.doclint.DocLint;
import org.itheima.edu.jcompiler.tools.javac.api.BasicJavacTask;
import org.itheima.edu.jcompiler.tools.javac.code.Source;
import org.itheima.edu.jcompiler.tools.javac.file.CacheFSInfo;
import org.itheima.edu.jcompiler.tools.javac.file.JavacFileManager;
import org.itheima.edu.jcompiler.tools.javac.jvm.Profile;
import org.itheima.edu.jcompiler.tools.javac.jvm.Target;
import org.itheima.edu.jcompiler.tools.javac.processing.AnnotationProcessingError;
...
import org.itheima.edu.jcompiler.tools.javac.util.Log.PrefixKind;
    ...
    public Collection<File> processArgs(String[] flags, String[] classNames) { // XXX sb protected
        ...
        if (showClass != null) {
            if (showClass.equals("showClass")) // no value given for option
                showClass = "org.itheima.edu.jcompiler.tools.javac.Main";
            showClass(showClass);
        }
...
//    }
    ...
    public static final String javacBundleName =
        "org.itheima.edu.jcompiler.tools.javac.resources.javac";
//
