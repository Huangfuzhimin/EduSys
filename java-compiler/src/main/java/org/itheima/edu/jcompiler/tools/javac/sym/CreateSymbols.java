...
package org.itheima.edu.jcompiler.tools.javac.sym;

import org.itheima.edu.jcompiler.tools.javac.api.JavacTaskImpl;
import org.itheima.edu.jcompiler.tools.javac.code.Kinds;
import org.itheima.edu.jcompiler.tools.javac.code.Scope;
import org.itheima.edu.jcompiler.tools.javac.code.Symbol.*;
import org.itheima.edu.jcompiler.tools.javac.code.Symbol;
import org.itheima.edu.jcompiler.tools.javac.code.Attribute;
import org.itheima.edu.jcompiler.tools.javac.code.Symtab;
import org.itheima.edu.jcompiler.tools.javac.code.Type;
import org.itheima.edu.jcompiler.tools.javac.code.Types;
import org.itheima.edu.jcompiler.tools.javac.jvm.ClassWriter;
import org.itheima.edu.jcompiler.tools.javac.jvm.Pool;
 ...
 *
 * <dl>
 * <dt>org.itheima.edu.jcompiler.tools.javac.sym.Jar</dt>
 * <dd>Specifies the location of rt.jar.</dd>
 * <dt>org.itheima.edu.jcompiler.tools.javac.sym.Dest</dt>
 ...
 */
@SupportedOptions({
    "org.itheima.edu.jcompiler.tools.javac.sym.Jar",
    "org.itheima.edu.jcompiler.tools.javac.sym.Dest",
    "org.itheima.edu.jcompiler.tools.javac.sym.Profiles"})
@SupportedAnnotationTypes("*")
public class CreateSymbols extends AbstractProcessor {

    static Set<String> getLegacyPackages() {
        ResourceBundle legacyBundle
            = ResourceBundle.getBundle("org.itheima.edu.jcompiler.tools.javac.resources.legacy");
    ...
    void createSymbols() throws IOException {
        ...
        String jarName = pOptions.get("org.itheima.edu.jcompiler.tools.javac.sym.Jar");
        if (jarName == null)
            throw new RuntimeException("Must use -Aorg.itheima.edu.jcompiler.tools.javac.sym.Jar=LOCATION_OF_JAR");
        String destName = pOptions.get("org.itheima.edu.jcompiler.tools.javac.sym.Dest");
        if (destName == null)
            throw new RuntimeException("Must use -Aorg.itheima.edu.jcompiler.tools.javac.sym.Dest=LOCATION_OF_JAR");
        String profileSpec=pOptions.get("org.itheima.edu.jcompiler.tools.javac.sym.Profiles");
        if (profileSpec == null)
            throw new RuntimeException("Must use -Aorg.itheima.edu.jcompiler.tools.javac.sym.Profiles=PROFILES_SPEC");
        ...
        org.itheima.edu.jcompiler.tools.javac.main.JavaCompiler compiler =
            org.itheima.edu.jcompiler.tools.javac.main.JavaCompiler.instance(task.getContext());
    ...
    public static void main(String... args) {
        ...
        args = new String[] {
            ...
            "-proc:only",
            "-processor",
            "org.itheima.edu.jcompiler.tools.javac.sym.CreateSymbols",
            "-Aorg.itheima.edu.jcompiler.tools.javac.sym.Jar=" + rt_jar,
            "-Aorg.itheima.edu.jcompiler.tools.javac.sym.Dest=" + dest,
            ...
            "org.xml.sax.ext",
            "org.xml.sax.helpers",
            "org.itheima.edu.jcompiler.java.browser.dom",
            "org.w3c.dom",
            "org.w3c.dom.bootstrap",
            "org.w3c.dom.ls",
            "org.w3c.dom.ranges",
            ...
            "org.w3c.dom.events",
            "org.w3c.dom.views",
            "org.itheima.edu.jcompiler.management",
            "org.itheima.edu.jcompiler.security.auth",
            "org.itheima.edu.jcompiler.security.auth.callback",
            "org.itheima.edu.jcompiler.security.auth.login",
            "org.itheima.edu.jcompiler.security.auth.module",
            "org.itheima.edu.jcompiler.security.jgss",
            "org.itheima.edu.jcompiler.net.httpserver",
            "org.itheima.edu.jcompiler.net.httpserver.spi",
            "javax.smartcardio"
            // </editor-fold>
        };
        org.itheima.edu.jcompiler.tools.javac.Main.compile(args);
    }
