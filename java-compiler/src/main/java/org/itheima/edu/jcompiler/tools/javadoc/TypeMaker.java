...
import static org.itheima.edu.jcompiler.tools.javac.code.TypeTag.ARRAY;
...
public class TypeMaker {
    ...
    public static org.itheima.edu.jcompiler.javadoc.Type getType(DocEnv env, Type t) {
     ...
     */
    public static org.itheima.edu.jcompiler.javadoc.Type[] getTypes(DocEnv env, List<Type> ts) {
        return getTypes(env, ts, new org.itheima.edu.jcompiler.javadoc.Type[ts.length()]);
    }
     ...
     */
    public static org.itheima.edu.jcompiler.javadoc.Type[] getTypes(DocEnv env, List<Type> ts,
                                                  org.itheima.edu.jcompiler.javadoc.Type res[]) {
        int i = 0;
        for (Type t : ts) {
            res[i++] = getType(env, t);
        }
    ...
    private static class ArrayTypeImpl implements org.itheima.edu.jcompiler.javadoc.Type {
        ...
        private org.itheima.edu.jcompiler.javadoc.Type skipArraysCache = null;

        public org.itheima.edu.jcompiler.javadoc.Type getElementType() {
            return TypeMaker.getType(env, env.types.elemtype(arrayType));
        }

        private org.itheima.edu.jcompiler.javadoc.Type skipArrays() {
