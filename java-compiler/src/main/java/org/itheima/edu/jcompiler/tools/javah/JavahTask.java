...
package org.itheima.edu.jcompiler.tools.javah;
...
//                throw new BadArgs("jni.no.stubs");
    ...
    private static final String versionRBName = "org.itheima.edu.jcompiler.tools.javah.resources.version";
    ...
    private String getMessage(Locale locale, String key, Object... args) {
        ...
        if (b == null) {
            try {
                b = ResourceBundle.getBundle("org.itheima.edu.jcompiler.tools.javah.resources.l10n", locale);
