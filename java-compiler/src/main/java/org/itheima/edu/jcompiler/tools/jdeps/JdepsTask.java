 ...
 * questions.
 */
package org.itheima.edu.jcompiler.tools.jdeps;

import org.itheima.edu.jcompiler.tools.classfile.AccessFlags;
...
import org.itheima.edu.jcompiler.tools.classfile.Dependencies;
import org.itheima.edu.jcompiler.tools.classfile.Dependencies.ClassFileError;
import org.itheima.edu.jcompiler.tools.classfile.Dependency;
import org.itheima.edu.jcompiler.tools.classfile.Dependency.Location;
import org.itheima.edu.jcompiler.tools.jdeps.PlatformClassPath.JDKArchive;
import static org.itheima.edu.jcompiler.tools.jdeps.Analyzer.Type.*;
import java.io.*;
...
class JdepsTask {
    ...
    private static class ResourceBundleHelper {
        ...
        static {
            ...
            try {
                bundle = ResourceBundle.getBundle("org.itheima.edu.jcompiler.tools.jdeps.resources.jdeps", locale);
            } catch (MissingResourceException e) {
                throw new InternalError("Cannot find jdeps resource bundle for locale " + locale);
            }
            try {
                versionRB = ResourceBundle.getBundle("org.itheima.edu.jcompiler.tools.jdeps.resources.version");
            } catch (MissingResourceException e) {
                throw new InternalError("version.resource.missing");
            }
            try {
                jdkinternals = ResourceBundle.getBundle("org.itheima.edu.jcompiler.tools.jdeps.resources.jdkinternals");
            } catch (MissingResourceException e) {
