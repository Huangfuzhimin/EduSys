...
package org.itheima.edu.jcompiler.tools.sjavac.server;
...
import org.itheima.edu.jcompiler.tools.javac.util.BaseFileManager;
import org.itheima.edu.jcompiler.tools.javac.util.StringUtils;
import org.itheima.edu.jcompiler.tools.sjavac.comp.Dependencies;
import org.itheima.edu.jcompiler.tools.sjavac.comp.JavaCompilerWithDeps;
import org.itheima.edu.jcompiler.tools.sjavac.comp.SmartFileManager;
import org.itheima.edu.jcompiler.tools.sjavac.comp.ResolveWithDeps;
...
public class CompilerThread implements Runnable {
    ...
    private org.itheima.edu.jcompiler.tools.javac.api.JavacTool compiler;
    ...
    public synchronized void use() {
        assert(!inUse);
        inUse = true;
        compiler = org.itheima.edu.jcompiler.tools.javac.api.JavacTool.create();
    ...
    public void run() {
        ...
        try {
            ...
            org.itheima.edu.jcompiler.tools.javac.util.ListBuffer<JavaFileObject> compilationUnits =
                new org.itheima.edu.jcompiler.tools.javac.util.ListBuffer<JavaFileObject>();
            for (JavaFileObject i : fileManager.getJavaFileObjectsFromFiles(the_classes)) {
                compilationUnits.append(i);
            }
            // Now deal with sources supplied as source_to_compile.
            org.itheima.edu.jcompiler.tools.javac.util.ListBuffer<File> sourcesToCompileFiles =
                new org.itheima.edu.jcompiler.tools.javac.util.ListBuffer<File>();
            ...
            org.itheima.edu.jcompiler.tools.javac.main.Main.Result rc = org.itheima.edu.jcompiler.tools.javac.main.Main.Result.OK;
            try {
                if (compilationUnits.size() > 0) {
                    ...
                    // Process the options.
                    org.itheima.edu.jcompiler.tools.javac.api.JavacTool.processOptions(context, smartFileManager, the_options);
                    ...
                    org.itheima.edu.jcompiler.tools.javac.main.Main ccompiler = new org.itheima.edu.jcompiler.tools.javac.main.Main("javacTask", stderr);
