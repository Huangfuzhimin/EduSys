...
<div style="height: 90%;">
    ...
    <div id="containerLeft" class="split split-horizontal">
        ...
        <!-- 下部分 -->
        <div id="containerLeftDown" class="split split-vertical"></div>
    </div>
    <!-- 右侧 -->
...
<script type="text/javascript">
    ...
    function loadTree() {
        ...
        var callback = function (result) {
            ...
            codePanel.init(tree[0].nodes[0].nodes);
            codePanel.layout($("#codePanel"));

            $('#tree').treeview({
                data: tree,
                onNodeSelected: function (event, node) {
                    var open = codePanel.openTab(node.text);
                    if (!open) {
            ...
            codePanel.runClick(function () {
                var codes = codePanel.getCodes();
                console.log(codes);
            });
        }
