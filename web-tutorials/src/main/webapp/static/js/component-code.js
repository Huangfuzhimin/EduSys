function CodePanel() {
    ...
    var btnRun = $('<a class="btn-floating red" style="margin: 5px;"><i class="material-icons">send</i></a>');
    var btnReset = $('<a class="btn-floating red" style="margin: 5px;"><i class="material-icons">refresh</i></a>');
    this.optionsContianer.append(btnRun);
    this.optionsContianer.append(btnReset);
...
CodePanel.prototype = {
    openTab: function (node) {
        ...
        if (self.exists(title)) {
            ...
            //存储
            self.map.put(title, {editor: editor});
